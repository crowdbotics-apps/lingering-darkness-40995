...
## Project Structure
    ...
    ├── lingering_darkness_40995  # Django project configurations
...
1. Clone this repo and `cd lingering_darkness_40995`
...
2. Clone this repo and `cd lingering_darkness_40995`
